<%@ Page Language="VB" AutoEventWireup="false" CodeFile="indexregister.aspx.vb" Inherits="indexregister" %>
	...
	<div class="banner" id="home">
		...
		<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:manandoshi1607@gmail.com">delishfood@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 9619619735</li>	
					<li>
						<div class="search">
...
&nbsp;</div>
					...
					<div class="col-md-3 form-date-w3-agileits">
                                ...
                                &nbsp;<asp:Label ID="invalids" runat="server" Text="Invalid Entries" Visible="False"></asp:Label>
								</div>
...
<!-- //banner -->
 <div class="ab-w3l-about">
	<div class="container">
		 <h3 class="tittle-w3"><span>Welcome to Our/span&gt; Delish Foodrum rerum hic tenetur a sapiente delectus reiciendis maiores hasellusMaecenas ac hendrerit purus. Lorem ipsum dolor sit amet.Lorem Ipsum is simply dummy text of the printing and typesetting industry
